...
- [ ] **1.1** Add `Breadcrumbs` row to the Body Sections table in checkpoint-format.md
...
- [ ] **2.3** Ensure checkpoint follows full format specification
